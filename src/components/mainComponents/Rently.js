...
export default class Rently extends React.Component {
    constructor(props) {
      super(props);
      this.state = {
          phrase:'',
    ...
    await axios.get('https://jsonbox.io/box_f3ad47a8484eb5897d71/rently')
          .then(response => {
    ...
    await axios.delete(`https://jsonbox.io/box_f3ad47a8484eb5897d71/rently/${id}`)
        .then(res => {
            console.log(res);
    ...
    async handleSubmit(event){      
        ...
        console.log(phrase);
    await axios.post('https://jsonbox.io/box_f3ad47a8484eb5897d71/rently', phrase)
